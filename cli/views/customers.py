...
class CustomersView:
    """
    Vue CLI pour la gestion des clients.
    Permet aux utilisateurs de créer, lire, mettre à jour et supprimer des clients
    ...
    def get_customer_menu_options(self, user) -> list:
        options = []
    ...
    def create_customer(self, user):
        ...
        try:
            ...
            company = self.click.prompt('Entreprise')
    ...
    def update_customer(self, user, customer_id):
        ...
        while True:
            ...
            new_val = self.click.prompt(label, default=str(current_val) if current_val is not None else '')
